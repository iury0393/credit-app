...
import 'package:credit_app/framework/flip_card.dart';
...
class ItemPage extends StatelessWidget {
  ...
  final MultiTrackTween animacaoCard = MultiTrackTween([
    Track('rotate').add(Duration(milliseconds: 300), Tween(begin: 0.0, end: -1.57)),
    Track('top')
  ...
  ItemPage({Key key, this.color, this.index, this.numberCard, this.name, this.imageURL})
      : super(key: key);
                      ...
                      child: Transform.rotate(
                        ...
                        child: Transform.scale(
                          ...
                          child: ControlledAnimation(
                            ...
                            playback:
                                pageIndex > index ? Playback.PLAY_FORWARD : Playback.PLAY_REVERSE,
                            builder: (context, animation) {
